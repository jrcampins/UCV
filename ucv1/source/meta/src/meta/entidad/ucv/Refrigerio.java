...
/**
 * Refregerio Persistent Entity.
 *
 * @author Jorge
 */
@EntityClass(resourceType = ResourceType.CONFIGURATION)
@EntityDataGen(start = 1, step = 1, stop = 15)
public class Refrigerio extends AbstractPersistentEntity {
...
/**/
    ...
    public Refrigerio(Artifact declaringArtifact, Field declaringField) {
    ...
    @BusinessKey
    @CharacterDataGen(type = DataGenType.SERIES, start = 110, step = 10, prefix = "R")
    public StringProperty codigo;

    @NameProperty
    @CharacterDataGen(type = DataGenType.SERIES, start = 110, step = 10, prefix = "Refrigerio #")
