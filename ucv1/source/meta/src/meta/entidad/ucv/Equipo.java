...
/**/
    ...
    public Equipo(Artifact declaringArtifact, Field declaringField) {
    ...
    @BusinessKey
    @CharacterDataGen(type = DataGenType.SERIES, start = 110, step = 10, prefix = "E")
    public StringProperty codigo;

    @NameProperty
    @CharacterDataGen(type = DataGenType.SERIES, start = 110, step = 10, prefix = "Equipo #")
