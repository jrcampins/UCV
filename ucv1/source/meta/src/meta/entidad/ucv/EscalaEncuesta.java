...
/**
 * EscalaEncuesta Persistent Entity.
 *
 * @author Jorge
 */
public class EscalaEncuesta extends AbstractPersistentEnumerationEntity {
...
/**/
    ...
    @Deprecated()
    private EscalaEncuesta() {
        this(null, null);
    }

    public EscalaEncuesta(Artifact declaringArtifact, Field declaringField) {
    ...
    public Instance MUY_DEFICIENTE;

    public Instance DEFICIENTE;

    public Instance ACEPTABLE;

    public Instance SATISFACTORIO;

    public Instance MUY_SATISFACTORIO;
