...
/**
 * DiaFeriado Persistent Entity.
 *
 * @author Jorge
 */
@EntityClass(resourceType = ResourceType.CONFIGURATION)
public class Feriado extends AbstractPersistentEntity {
...
/**/
    ...
    public Feriado(Artifact declaringArtifact, Field declaringField) {
    ...
    @ColumnField(nullable = Kleenean.FALSE)
    @PropertyField(create = Kleenean.TRUE, update = Kleenean.TRUE, table = Kleenean.TRUE, report = Kleenean.TRUE)
    public BooleanProperty recurrente;

    @Override
    protected void settleProperties() {
        super.settleProperties();
        recurrente.setInitialValue(false);
        recurrente.setDefaultValue(false);
        recurrente.setDefaultTooltip("indicador de feriado recurrente");
        recurrente.setDefaultDescription("indicador de feriado recurrente; "
            + "un dis feriado es recurrente si es feriado todos los años (por ejemplo, Navidad y Año Nuevo)");
    }

//  Instance NUEVO, DECLARACION, TRABAJADOR, CARABOBO, INDEPENDENCIA, NATALICIO, RESISTENCIA, NAVIDAD;
//
//  Instance LUNES, MARTES, JUEVES, VIERNES;
//
//  @Override
//  protected void settleInstances() {
//      super.settleInstances();
//      NUEVO.newInstanceField(id, 20000101);
//      NUEVO.newInstanceField(fecha, Date.valueOf("2000-01-01"));
//      NUEVO.newInstanceField(evento, "Año Nuevo");
//      NUEVO.newInstanceField(recurrente, true);
//      /**/
//      DECLARACION.newInstanceField(id, 20000419);
//      DECLARACION.newInstanceField(fecha, Date.valueOf("2000-04-19"));
//      DECLARACION.newInstanceField(evento, "Declaración de la Independencia");
//      DECLARACION.newInstanceField(recurrente, true);
//      /**/
//      TRABAJADOR.newInstanceField(id, 20000501);
//      TRABAJADOR.newInstanceField(fecha, Date.valueOf("2000-05-01"));
//      TRABAJADOR.newInstanceField(evento, "Dia del Trabajador");
//      TRABAJADOR.newInstanceField(recurrente, true);
//      /**/
//      CARABOBO.newInstanceField(id, 20000624);
//      CARABOBO.newInstanceField(fecha, Date.valueOf("2000-06-24"));
//      CARABOBO.newInstanceField(evento, "Batalla de Carabobo");
//      CARABOBO.newInstanceField(recurrente, true);
//      /**/
//      INDEPENDENCIA.newInstanceField(id, 20000705);
//      INDEPENDENCIA.newInstanceField(fecha, Date.valueOf("2000-07-05"));
//      INDEPENDENCIA.newInstanceField(evento, "Dia de la Independencia");
//      INDEPENDENCIA.newInstanceField(recurrente, true);
//      /**/
//      NATALICIO.newInstanceField(id, 20000724);
//      NATALICIO.newInstanceField(fecha, Date.valueOf("2000-07-24"));
//      NATALICIO.newInstanceField(evento, "Natalicio de Simón Bolívar");
//      NATALICIO.newInstanceField(recurrente, true);
//      /**/
//      RESISTENCIA.newInstanceField(id, 20001012);
//      RESISTENCIA.newInstanceField(fecha, Date.valueOf("2000-10-12"));
//      RESISTENCIA.newInstanceField(evento, "Dia de la Resistencia Indígena");
//      RESISTENCIA.newInstanceField(recurrente, true);
//      /**/
//      NAVIDAD.newInstanceField(id, 20001225);
//      NAVIDAD.newInstanceField(fecha, Date.valueOf("2000-12-25"));
//      NAVIDAD.newInstanceField(evento, "Navidad");
//      NAVIDAD.newInstanceField(recurrente, true);
//      /**/
//      LUNES.newInstanceField(id, 20150216);
//      LUNES.newInstanceField(fecha, Date.valueOf("2015-02-16"));
//      LUNES.newInstanceField(evento, "Lunes de Carnaval 2015");
//      /**/
//      MARTES.newInstanceField(id, 20150217);
//      MARTES.newInstanceField(fecha, Date.valueOf("2015-02-17"));
//      MARTES.newInstanceField(evento, "Martes de Carnaval 2015");
//      /**/
//      JUEVES.newInstanceField(id, 20150402);
//      JUEVES.newInstanceField(fecha, Date.valueOf("2015-04-02"));
//      JUEVES.newInstanceField(evento, "Jueves Santo 2015");
//      /**/
//      VIERNES.newInstanceField(id, 20150403);
//      VIERNES.newInstanceField(fecha, Date.valueOf("2015-04-03"));
//      VIERNES.newInstanceField(evento, "Viernes Santo 2015");
//  }
//
}
