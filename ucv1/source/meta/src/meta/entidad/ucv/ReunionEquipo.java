...
public class ReunionEquipo extends AbstractPersistentEntity {
...
/**/
    ...
    @Deprecated()
    private ReunionEquipo() {
        this(null, null);
    }

    public ReunionEquipo(Artifact declaringArtifact, Field declaringField) {
    ...
    protected void settleAttributes() {
        ...
        setDefaultLabel("asociación Reunión/Equipo");
        setDefaultCollectionLabel("asociaciones Reunión/Equipo");
        setDefaultLabel(reunion, "equipo requerido");
        setDefaultShortLabel(reunion, "equipo");
        setDefaultCollectionLabel(reunion, "equipos requeridos");
        setDefaultCollectionShortLabel(reunion, "equipos");
        setDefaultLabel(equipo, "reunión");
        setDefaultShortLabel(equipo, "reunión");
        setDefaultCollectionLabel(equipo, "reuniones");
        setDefaultCollectionShortLabel(equipo, "reuniones");
    }
