...
public class Persona extends AbstractPersistentEntity {
...
/**/
     ...
     */
    @BusinessKey
    @CharacterDataGen(pattern = "V-00000000")
    @StringField(maxLength = 10, regex = "[VE]\\-[\\d]{1,8}")
    ...
    @StringField(maxLength = 100, regex = "[a-zA-Z_0-9\\.\\-]{1,}\\@[a-zA-Z_0-9\\.\\-]{1,}")
    ...
    @PropertyField(create = Kleenean.TRUE)
    @CharacterDataGen(nullable = 100)
    @StringField(maxLength = 20, regex = "\\+[\\d]{1,3} [\\d]{2,3}-[\\d]{6,8}")
    ...
    @CharacterDataGen(nullable = 100)
    @StringField(maxLength = 20, regex = "\\+[\\d]{1,3} [\\d]{2,3}-[\\d]{6,8}")
    public StringProperty telefonoTrabajo;
    ...
    @PropertyField(create = Kleenean.TRUE)
    @CharacterDataGen(nullable = 100)
    public StringProperty direccionOficina;
    ...
    @CharacterDataGen(nullable = 100)
    @StringField(maxLength = 20, regex = "\\+[\\d]{1,3} [\\d]{2,3}-[\\d]{6,8}")
    public StringProperty telefonoHabitacion;
    ...
    @PropertyField(create = Kleenean.TRUE)
    @CharacterDataGen(nullable = 100)
    public StringProperty direccionHabitacion;
    ...
    protected void settleProperties() {
        ...
        cedula.setDefaultTooltip("cédula de identidad");
        cedula.setDefaultDescription("cédula de identidad de la persona; "
            + "comienza por una letra (V ó E) que identifica la nacionalidad, "
            + "seguida de un guión y hasta 8 digitos del número de cédula");
        correoElectronico.setDefaultTooltip("dirección de correo electrónico");
        correoElectronico.setDefaultDescription("dirección de correo electrónico de la persona;"
            + "consta de dos bloques de letras, números, guiones y/o puntos separados por el signo @");
        telefonoMovil.setDefaultTooltip("número de teléfono móvil");
        telefonoMovil.setDefaultDescription("número de teléfono móvil de la persona; "
            + "comienza por el prefijo de pais (signo + y hasta 3 digitos) seguido por un espacio "
            + "y el prefijo local (2 ó 3 digitos), seguido por un guión y el resto del número (6 a 8 digitos)");
        telefonoTrabajo.setDefaultTooltip("número de teléfono del lugar de trabajo");
        telefonoTrabajo.setDefaultDescription("número de teléfono del lugar de trabajo de la persona; "
            + "comienza por el prefijo de pais (signo + y hasta 3 digitos) seguido por un espacio "
            + "y el prefijo local (2 ó 3 digitos), seguido por un guión y el resto del número (6 a 8 digitos)");
        telefonoHabitacion.setDefaultTooltip("número de teléfono del lugar de habitación");
        telefonoHabitacion.setDefaultDescription("número de teléfono del lugar de habitación de la persona; "
            + "comienza por el prefijo de pais (signo + y hasta 3 digitos) seguido por un espacio "
            + "y el prefijo local (2 ó 3 digitos), seguido por un guión y el resto del número (6 a 8 digitos)");
    }
