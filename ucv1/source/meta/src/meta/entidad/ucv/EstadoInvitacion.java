...
/**
 * EstadoReunionPersona Persistent Entity.
 *
 * @author Jorge
 */
public class EstadoInvitacion extends AbstractPersistentEnumerationEntity {
...
/**/
    ...
    @Deprecated()
    private EstadoInvitacion() {
        this(null, null);
    }

    public EstadoInvitacion(Artifact declaringArtifact, Field declaringField) {
    ...
    protected void settleAttributes() {
        ...
        setDefaultLabel("estado de invitación");
        setDefaultShortLabel("estado");
        setDefaultCollectionLabel("estados de invitación");
