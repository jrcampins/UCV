...
/**
 * ReunionPersona Persistent Entity.
 *
 * @author Jorge
 */
@EntityClass(independent = Kleenean.FALSE, resourceType = ResourceType.OPERATION)
public class Invitacion extends AbstractPersistentEntity {
...
/**/
    ...
    public Invitacion(Artifact declaringArtifact, Field declaringField) {
    ...
    protected void settleAttributes() {
        ...
        setDefaultLabel(reunion, "invitado");
        setDefaultShortLabel(reunion, "invitado");
        setDefaultCollectionLabel(reunion, "invitados");
        setDefaultCollectionShortLabel(reunion, "invitados");
    }
    ...
    @PropertyField(create = Kleenean.TRUE, update = Kleenean.FALSE)
...
//  @OwnerProperty
    ...
    public BooleanProperty indispensable;
    ...
    public EstadoInvitacion estado;
    ...
    protected void settleProperties() {
        ...
        nombre.setInitialValue(invitado.nombre.concat(" / ").concat(reunion.asunto));
        nombre.setDefaultValue(invitado.nombre.concat(" / ").concat(reunion.asunto));
        nombre.setDefaultLabel("invitado / reunión");
        nombre.setDefaultShortLabel("invitado / reunión");
        indispensable.setInitialValue(false);
        indispensable.setDefaultValue(false);
    ...
    State pendiente, enviada, aceptada, rechazada;

    @Override
    protected void settleExpressions() {
        super.settleExpressions();
        pendiente = estado.isEqualTo(estado.PENDIENTE);
        pendiente.setDefaultErrorMessage("la invitación no está pendiente");
        enviada = estado.isEqualTo(estado.ENVIADA);
        enviada.setDefaultErrorMessage("la invitación no está enviada");
        aceptada = estado.isEqualTo(estado.ACEPTADA);
        aceptada.setDefaultErrorMessage("la invitación no está aceptada");
        rechazada = estado.isEqualTo(estado.RECHAZADA);
        rechazada.setDefaultErrorMessage("la invitación no está rechazada");
    }

    @Override
    protected void settleFilters() {
        super.settleFilters();
        setDeleteFilter(pendiente);
    }
    ...
    public class Enviar extends ProcessOperation {
        ...
        protected void settleParameters() {
            ...
            invitacion.nombre.setDefaultLabel("invitado / reunión");
            invitacion.nombre.setDefaultShortLabel("invitado / reunión");
            invitacion.estado.setCurrentValue(estado.ENVIADA);
            invitacion.fechaHoraEstado.setCurrentValue(SpecialTemporalValue.CURRENT_TIMESTAMP);
        }
    ...
    public class Aceptar extends ProcessOperation {
        ...
        protected void settleParameters() {
            ...
            invitacion.nombre.setDefaultLabel("invitado / reunión");
            invitacion.nombre.setDefaultShortLabel("invitado / reunión");
            invitacion.estado.setCurrentValue(estado.ACEPTADA);
            invitacion.fechaHoraEstado.setCurrentValue(SpecialTemporalValue.CURRENT_TIMESTAMP);
        }
    ...
    public class Rechazar extends ProcessOperation {
        ...
        protected void settleParameters() {
            ...
            invitacion.nombre.setDefaultLabel("invitado / reunión");
            invitacion.nombre.setDefaultShortLabel("invitado / reunión");
            invitacion.estado.setCurrentValue(estado.RECHAZADA);
            invitacion.fechaHoraEstado.setCurrentValue(SpecialTemporalValue.CURRENT_TIMESTAMP);
        }
    ...
    protected void settleOperations() {
        ...
        enviar.addTransition(pendiente, enviada);
        enviar.addTransition(enviada, enviada);
        /**/
        aceptar.addTransition(pendiente, aceptada);
        aceptar.addTransition(enviada, aceptada);
        aceptar.addTransition(rechazada, aceptada);
        /**/
        rechazar.addTransition(pendiente, rechazada);
        rechazar.addTransition(enviada, rechazada);
        rechazar.addTransition(aceptada, rechazada);
        /**/
//      aceptar.addTriggerOn(enviada);
    }
