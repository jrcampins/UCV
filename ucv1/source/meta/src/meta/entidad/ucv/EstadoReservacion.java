...
/**
 * EstadoReservacion Persistent Entity.
 *
 * @author Jorge
 */
public class EstadoReservacion extends AbstractPersistentEnumerationEntity {
...
/**/
    ...
    public EstadoReservacion(Artifact declaringArtifact, Field declaringField) {
    ...
    protected void settleAttributes() {
        ...
        setDefaultLabel("estado de reservación");
        setDefaultShortLabel("estado");
        setDefaultCollectionLabel("estados de reservación");
        setDefaultCollectionShortLabel("estados");
    }
    ...
    public Instance PENDIENTE;

    public Instance SOLICITADA;

    public Instance CONFIRMADA;
