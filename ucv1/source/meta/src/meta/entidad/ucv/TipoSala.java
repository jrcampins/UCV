...
/**
 * TipoSala Persistent Entity.
 *
 * @author Jorge
 */
public class TipoSala extends AbstractPersistentEnumerationEntity {
...
/**/
    ...
    public TipoSala(Artifact declaringArtifact, Field declaringField) {
    ...
    protected void settleAttributes() {
        ...
        setDefaultLabel("tipo de sala");
        setDefaultShortLabel("tipo");
        setDefaultCollectionLabel("tipos de sala");
    ...
    public Instance REUNION;

    public Instance AUDITORIO;

    public Instance SALA_DE_FIESTA;

    public Instance OFICINA;
