...
/**
 * EstadoReunion Persistent Entity.
 *
 * @author Jorge
 */
public class EstadoReunion extends AbstractPersistentEnumerationEntity {
...
/**/
    ...
    public EstadoReunion(Artifact declaringArtifact, Field declaringField) {
    ...
    protected void settleAttributes() {
        ...
        setDefaultLabel("estado de reunión");
        setDefaultShortLabel("estado");
        setDefaultCollectionLabel("estados de reunión");
