...
public class ReunionSala extends AbstractPersistentEntity {
...
/**/
    ...
    public ReunionSala(Artifact declaringArtifact, Field declaringField) {
    ...
    protected void settleAttributes() {
        ...
        setDefaultLabel("asociación Reunión/Sala");
        setDefaultCollectionLabel("asociaciones Reunión/Sala");
        setDefaultLabel(reunion, "sala disponible");
        setDefaultShortLabel(reunion, "sala");
        setDefaultCollectionLabel(reunion, "salas disponibles");
        setDefaultCollectionShortLabel(reunion, "salas");
    }
    ...
    @ColumnField(nullable = Kleenean.FALSE)
    @PropertyField(hidden = Kleenean.TRUE)
    public DateProperty fechaInicioDisponibilidad;
    ...
    @ColumnField(nullable = Kleenean.FALSE)
    @PropertyField(hidden = Kleenean.TRUE)
    public TimeProperty horaInicioDisponibilidad;
    ...
    @ColumnField(nullable = Kleenean.FALSE)
    @PropertyField(hidden = Kleenean.TRUE)
    public TimestampProperty fechaHoraInicioDisponibilidad;
    ...
    @ColumnField(nullable = Kleenean.FALSE)
    @PropertyField(hidden = Kleenean.TRUE)
    public DateProperty fechaFinDisponibilidad;
    ...
    @ColumnField(nullable = Kleenean.FALSE)
    @PropertyField(hidden = Kleenean.TRUE)
    public TimeProperty horaFinDisponibilidad;
    ...
    @ColumnField(nullable = Kleenean.FALSE)
    @PropertyField(hidden = Kleenean.TRUE)
    public TimestampProperty fechaHoraFinDisponibilidad;
    ...
    public BooleanProperty reservacionSolicitada;
    ...
    public TimestampProperty fechaHoraSolicitud;
    ...
    protected void settleProperties() {
        ...
        nombre.setInitialValue(reunion.asunto.concat(" / ").concat(sala.nombre));
        nombre.setDefaultValue(reunion.asunto.concat(" / ").concat(sala.nombre));
        nombre.setDefaultLabel("reunión / sala");
        nombre.setDefaultShortLabel("reunión / sala");
        reservacionSolicitada.setInitialValue(false);
        reservacionSolicitada.setDefaultValue(false);
    }
    ...
    State solicitada, noSolicitada;

    @Override
    protected void settleExpressions() {
        super.settleExpressions();
        solicitada = reservacionSolicitada.isTrue();
        solicitada.setDefaultErrorMessage("la sala no está solicitada");
        noSolicitada = reservacionSolicitada.isFalse();
        noSolicitada.setDefaultErrorMessage("la sala ya está solicitada");
    }

    @Override
    protected void settleFilters() {
        super.settleFilters();
        setDeleteFilter(noSolicitada);
    }
    ...
    public class SolicitarReservacionSala extends ProcessOperation {
         ...
         */
        @InstanceReference
        protected ReunionSala opcion;

        @Override
        protected void settleParameters() {
            super.settleParameters();
            opcion.nombre.setDefaultLabel("reunión / sala");
            opcion.nombre.setDefaultShortLabel("reunión / sala");
            opcion.reservacionSolicitada.setCurrentValue(true);
            opcion.fechaHoraSolicitud.setCurrentValue(SpecialTemporalValue.CURRENT_TIMESTAMP);
        }
        ...
        protected void settleExpressions() {
            super.settleExpressions();
            check1 = and(
                opcion.reunion.reservacion.isNotEqualTo(opcion.reunion.reservacion.SOLICITADA),
                opcion.reunion.reservacion.isNotEqualTo(opcion.reunion.reservacion.CONFIRMADA)
            );
            check1.setDefaultErrorMessage("la reunión ya tiene una reservación solicitada o confirmada");
        }

        @Override
        protected void settleFilters() {
            super.settleFilters();
            opcion.setSearchQueryFilter(check1);
        }
    ...
    protected void settleOperations() {
        ...
        insert.addTransition(null, noSolicitada);
        solicitarReservacionSala.addTransition(noSolicitada, solicitada);
    }
